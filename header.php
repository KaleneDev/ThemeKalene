        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          ...
          -->
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="hidden sm:ml-6 sm:block flex m-auto">
                        ...
                        wp_nav_menu(
                            array(
                                ...
                                'link_before' => '<span class="text-gray-700 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">',
                            )
                        );
                        ?>
                    </div>
